...
class ColorManagedTrait_v1:
    ...
    def setConfigTemplate(self, configTemplate: str):
        ...
        Config template.
        """
        if not type(configTemplate) is str:
...
class ImageTrait_v1:
    ...
    def setCompression(self, compression: str):
        ...
        """
        if not type(compression) is str:
    ...
    def setOverscanHeight(self, overscanHeight: int):
        ...
        """
        if not type(overscanHeight) is int:
    ...
    def setOverscanWidth(self, overscanWidth: int):
        ...
        """
        if not type(overscanWidth) is int:
...
class TextureTrait(TextureTrait_v1):
    """
    A trait indicating a texture.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use TextureTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " TextureTrait to TextureTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
