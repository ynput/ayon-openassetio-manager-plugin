...
class WorkfileTrait(WorkfileTrait_v1):
    """
    A trait indicating a workfile.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use WorkfileTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " WorkfileTrait to WorkfileTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
