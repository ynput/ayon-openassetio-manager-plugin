...
class ClipTrait_v1:
    ...
    def setFrameRate(self, frameRate: float):
        ...
        """
        if not type(frameRate) is float:
    ...
    def setHandlesStart(self, handlesStart: int):
        ...
        """
        if not type(handlesStart) is int:
    ...
    def setInclusiveHandles(self, inclusiveHandles: bool):
        ...
        """
        if not type(inclusiveHandles) is bool:
...
class CacheTrait(CacheTrait_v1):
    """
    A trait indicating a cached entity.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use CacheTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " CacheTrait to CacheTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class ClipTrait(ClipTrait_v1):
    """
    A trait indicating time defined clip with start, end and rate.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use ClipTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " ClipTrait to ClipTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class SequenceTrait(SequenceTrait_v1):
    """
    A trait similar to Clip.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use SequenceTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " SequenceTrait to SequenceTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
