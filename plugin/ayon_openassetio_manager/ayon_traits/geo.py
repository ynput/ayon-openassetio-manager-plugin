...
class ModelTrait_v1:
    ...
    def setBoundingBox(self, boundingBox: str):
        ...
        """
        if not type(boundingBox) is str:
...
class CameraTrait(CameraTrait_v1):
    """
    A trait indicating a camera.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use CameraTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " CameraTrait to CameraTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class LookTrait(LookTrait_v1):
    """
    A trait indicating a look.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use LookTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " LookTrait to LookTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class ModelTrait(ModelTrait_v1):
    """
    A trait indicating a model.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use ModelTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " ModelTrait to ModelTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class PointCacheTrait(PointCacheTrait_v1):
    """
    A trait indicating a pointcache.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use PointCacheTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " PointCacheTrait to PointCacheTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class ProxyTrait(ProxyTrait_v1):
    """
    A trait indicating a proxy.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use ProxyTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " ProxyTrait to ProxyTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class RigTrait(RigTrait_v1):
    """
    A trait indicating a rig.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use RigTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " RigTrait to RigTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class SpatialContentTrait(SpatialContentTrait_v1):
    """
    A trait indicating a spatial content.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use SpatialContentTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " SpatialContentTrait to SpatialContentTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
...
class VolumeTrait(VolumeTrait_v1):
    """
    A trait indicating a volume.
    Usage: entity

    @deprecated Unversioned trait view classes are deprecated, please
    use VolumeTrait_v1 explicitly.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        warnings.warn(
            "Unversioned trait view classes are deprecated. Please switch from"
            " VolumeTrait to VolumeTrait_v1.",
            DeprecationWarning,
            stacklevel=2
        )
